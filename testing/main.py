...
class LinearTopo(Topo):
   ...
   def __init__(self, **opts):
        ...
        self.addLink( switch1, switch2 ,bw=BANDWIDTH, delay=DELAY, loss=LOSS, max_queue_size=MAX_QUEUE_SIZE )
...
if __name__ == '__main__':
    ...
    topo = LinearTopo()
    net= Mininet(topo=topo,link=TCLink,controller=functools.partial(RemoteController,ip='172.17.0.1:32769') )
    net.start()
